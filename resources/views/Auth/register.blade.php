...
<div class=" justify-center items-center flex">
    <div class="flex justify-center items-center">
        <div class="lg:w-[50%] w-full lg:ml-[190px] h-[600px]">
            <h1
                class="lg:text-left text-center font-black text-3xl leading-6 mt-[10px]  text-transparent bg-clip-text bg-gradient-to-r from-[#21BEFD] to-[#2176FF] lg:ml-[10px]">
                Welcome Back</h1>
            <h6 class="py-3 text-[#000000c0] font-serif ml-[10px] lg:text-left text-center lg:ml-[10px]">Request for a service</h6>
            {{-- ///////////// form//////// --}}
            <div class="form">
                <form action="{{route('save')}}" method="POST" class="w-[420px] flex flex-col">
                    @csrf
                   <div class="myform justify-center  items-center ">
