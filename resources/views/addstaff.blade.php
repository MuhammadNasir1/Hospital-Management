...
<form action="#">
    <div class="main flex lg-inline">
        <div class="lable1 px-10 ">
            ...
            <input type="text" name="fname"required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081] " placeholder="Enter first name">
        </div>
        <div class="lable1 px-10 ">
            <label for="lname" class="font-semibold">Last Name</label>
            <input type="text" name="lname" required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081]" placeholder="Enter  last name">
        </div>
        <div class="lable1 px-10  ">
    ...
    <div class="main flex mt-3">
        <div class="lable1 px-10 ">
            ...
            <input type="text" name="age" required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081]" placeholder=" Age Here">
        </div>
        <div class="lable1 px-10 ml-4">
  ...
  <select name="role" class="w-[300px] h-[40px]  rounded-md  border-2 broder-[#5D7081]  text-gray-500">
    ...
    <div class="main flex mt-1">
        <div class="lable1 px-10">
            <label for="phoneno" class="font-semibold">Phone Number</label>
            <input type="tel" name="phoneno"required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081] " placeholder="Enter Phone No">
        </div>
        <div class="lable1 px-10  mr-[70px]">
            <label for="email" class="font-semibold">Email</label>
            <input type="email" name="email" required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081]" placeholder="Enter  last name">
        </div>
        <div class="lable1   mr-[70px]">
            <label for="city" class="font-semibold">City</label>
            <input type="text" name="brith" required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081]" placeholder="City here">
        </div>
    </div>

    <div class="lable1  pt-2 px-10">
        <label  for="address" class="font-semibold">Address</label> <br>
        <input type="text" name="address" required class="w-[1100px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081]" placeholder="Enter Address here">
    </div>
    <h1 class="font-bold text-xl pt-[20px]  px-10">Education & Training</h1>
    <div class="main flex mt-1">
        <div class="lable1 px-10">
            <label for="mschool" class="font-semibold">Medical School</label>
            <input type="text" name="mschool"required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081] " placeholder="Enter Graduation Year">
        </div>
        <div class="lable1 px-10  mr-[70px]">
            <label for="gyear" class="font-semibold">Graduation Year</label>
            <input type="text" name="gyear" required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081]" placeholder="Enter Graduation Year">
        </div>
        <div class="lable1   mr-[70px]">
            <label for="residency" class="font-semibold">Residency</label>
            <input type="text" name="residency" required class="w-[300px] h-[40px] mt-1 rounded-md  border-2 broder-[#5D7081]" placeholder="Residency here">
        </div>
    </div>
    <h1 class="font-bold text-xl pt-[20px]  px-10">Additional Notes / Comments</h1>
    <textarea
    class="peer h-[114px] w-[1100px] mx-10 mt-2" name="message"
